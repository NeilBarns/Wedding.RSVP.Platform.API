...
class WeddingContentMapper
{
    ...
    {
        return ['eyebrow' => $v['eyebrow'] ?? null, 'headline' => $v['headline'] ?? null, 'subheadline' => $v['subheadline'] ?? null, 'hero_media_url' => $v['mediaUrl'] ?? null, 'hero_media_alt_text' => $v['mediaAltText'] ?? null, 'is_published' => $v['isPublished']];
    }

    public function story(array $v): array
    {
        return ['title' => $v['title'] ?? null, 'body' => $v['body'], 'image_url' => $v['imageUrl'] ?? null, 'image_alt_text' => $v['imageAltText'] ?? null, 'event_date' => $v['eventDate'] ?? null, 'sort_order' => $v['sortOrder'], 'is_published' => $v['isPublished']];
    }
    ...
    {
        return ['image_url' => $v['imageUrl'], 'alt_text' => $v['altText'] ?? null, 'caption' => $v['caption'] ?? null, 'sort_order' => $v['sortOrder'], 'is_published' => $v['isPublished']];
    }
}
